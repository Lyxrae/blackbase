                ...
                <div class="col-lg-6">
                    ...
                    <div class="approach-content">
                        ...
                        <div class="section-title">
                            ...
                            <h2 class="text-anime-style-3" data-cursor="-opaque">Crafting fresh flavors to your plate</h2>
                            <p class="wow fadeInUp" data-wow-delay="0.2s">At Blackbase, our approach blends tradition with innovation. We source the freshest catch daily, use authentic coastal recipes, and present every dish</p>
                        </div>
                        <!-- Section Title End -->
                        ...
                        <div class="approach-body">
                            ...
                            <div class="mission-vision-item wow fadeInUp" data-wow-delay="0.4s">
                                ...
                                <div class="mission-vision-content">
                                    <h3>Our mission</h3>
                                    <p>At Blackbase, our mission is to bring the true taste of the food to your plate. We are committed to serving the freshest food, inspired by coastal traditions and prepared</p>
                                </div>
            ...
            <div class="row">
                    ...
                    <div class="test-tradition-image-box">
                        ...
                        <div class="test-tradition-cta-box wow fadeInUp">
                            <div class="test-tradition-cta-header">
                                <h3>Enjoy 25% Off on Coastal Feast Week - Limited Time Only!</h3>
                            </div>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="test-tradition-content">
                        <!-- Section Title Start -->
                        <div class="section-title">
                            <h3 class="wow fadeInUp">Taste the Tradition</h3>
                            <h2 class="text-anime-style-3" data-cursor="-opaque">Expertly crafted from the coast, served with soul</h2>
                            <p class="wow fadeInUp" data-wow-delay="0.2s">Every dish in our signature selection is a reflection of our passion for coastal cuisine. Prepared with the freshest catch, local spices, and authentic techniques</p>
                        </div>
                        <!-- Section Title End -->
                        ...
                        <div class="test-tradition-body wow fadeInUp" data-wow-delay="0.4s">
                            ...
                            <div class="test-tradition-body-item">
                                <div class="icon-box">
                                    <img src="{{asset('frontend/images/icon-test-tradition-body-1.svg')}}" alt="">
                                </div>
                                <div class="test-tradition-item-content">
                                    <h3>Fresh FlavoDaily Catch</h3>
                                </div>
                            </div>
                            ...
                            <div class="test-tradition-body-item">
                                <div class="icon-box">
                                    <img src="{{asset('frontend/images/icon-test-tradition-body-2.svg')}}" alt="">
                                </div>
                                <div class="test-tradition-item-content">
                                    <h3>Inspired Cost Tradition</h3>
                                </div>
                            </div>
                            <!-- Test Tradition Body Item End -->    
                        </div>
                        ...
                        <div class="test-tradition-list wow fadeInUp" data-wow-delay="0.6s">
                            <ul>
                                <li>Carefully sourced fresh seafood from trusted coastal fisheries, ensuring.</li>
                                <li>Expertly balanced flavors using handpicked regional spices and traditional.</li>
                                <li>Lovingly prepared by seasoned chefs who bring generations of coastal culinary</li>
                            </ul>
                        </div>
